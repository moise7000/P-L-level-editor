...
//                    ScrollView{
//                        VStack{
//                            ForEach(getAssetsByType(allAssets, assetType: AssetsType.ENTITY), id: \.self) { entityName in
//                                Text(entityName.image)
//                                    .padding()
//                                    .onTapGesture {
//                                        isErazerSelected = false
//                                        self.selectedImage = entityName.url
//                                        
//                                    }
//                            }
//                        }
...
//                    ScrollView{
//                        VStack{
//                            ForEach(getAssetsByType(allAssets, assetType: AssetsType.STRUCTURE), id: \.self) { imageName in
//                                Text(imageName.image)
//                                    .scaleEffect(1.25)
//                                    .padding()
//                                    .onTapGesture {
//                                        isErazerSelected = false
//                                        self.selectedImage = imageName.url
//                                        
//                                    }
//                            }
//                        }
...
//                                                    Text(grid.images[row][column].image)
//                                                }
//                                            }
//                                            .onTapGesture {
//                                                
